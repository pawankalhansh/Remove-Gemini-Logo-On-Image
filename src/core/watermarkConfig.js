 ...
 * Portrait images use tighter margins so the search window starts closer
 * to the actual watermark position in tall outputs.
...
export function detectWatermarkConfig(imageWidth, imageHeight) {
    ...
    if (isPortrait) {
        // Portrait images: use reduced margins so the watermark anchor
        // search window is closer to the bottom-right corner.
    ...
    // Landscape / square: Gemini historical default rules.
    // If either edge is greater than 1024, use 96x96 watermark.
