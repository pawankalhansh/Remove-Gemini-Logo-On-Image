...
test('package should expose browser and image-data sdk subpaths', async () => {
    const browserSdk = await import('Remove-Gemini-Logo-On-Image/browser');
    const imageDataSdk = await import('Remove-Gemini-Logo-On-Image/image-data');
    const nodeSdk = await import('Remove-Gemini-Logo-On-Image/node');
